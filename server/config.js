...
module.exports = {
    ...
    servers: [
        ...
        },
        {
            share_client_server: false,
            proxy_client_server: true,
            host: process.env.HOST || `localhost:${defaultPort + 3}`,
            port: defaultPort + 3,
            id: 'uz',
            region: process.env.REGION || "USA",
            gamemode: ['tank_editor'],
            player_cap: 80,
            featured: false,
            unlisted: false,
            private: false,
        ...
        },
        {
            share_client_server: false,
            proxy_client_server: true,
            host: process.env.HOST || `localhost:${defaultPort + 4}`,
            port: defaultPort + 4,
            id: 'sm1',
            region: process.env.REGION || "USA",
            gamemode: ['shiny_member'],
            player_cap: 80,
            featured: false,
            unlisted: true,
            private: true,
        ...
        },
        {
            share_client_server: false,
            proxy_client_server: true,
            host: process.env.HOST || `localhost:${defaultPort + 5}`,
            port: defaultPort + 5,
            id: 'sm2',
            region: process.env.REGION || "USA",
            gamemode: ['shiny_member'],
