...
Class.bushwhacker.BODY = { FOV: 1.6 * base.FOV }
Class.bushwhacker.GUNS[0].PROPERTIES.SHOOT_SETTINGS = combineStats([g.basic, g.sniper])
Class.bushwhacker.GUNS[0].PROPERTIES.ALT_FIRE = true
Class.buttbuttin = makeGunner('assassin', "Buttbuttin", {rear: true})
Class.bushwhacker.GUNS.push({
    POSITION: {
        LENGTH: 24,
        WIDTH: 8
    },
    PROPERTIES: {
        SHOOT_SETTINGS: combineStats([g.basic, g.sniper, {recoil: 50, reload: 0.05, damage: 10, penetration: 5}]),
        TYPE: 'bullet',
        ALT_FIRE: true
    }
})
...
Class.autoVocal = makeAuto('vocal')
...
// Class Tree
Class.basic.UPGRADES_TIER_1 = ['twin', 'sniper', 'machineGun', 'flankGuard', 'director', 'pounder', 'trapper', 'desmos', 'whirlwind']
    Class.basic.UPGRADES_TIER_2 = ['smasher', 'healer', 'vocal']
    ...
    Class.flankGuard.UPGRADES_TIER_2 = ['hexaTank', 'triAngle', 'auto3', 'trapGuard', 'triTrapper']
        ...
        Class.triAngle.UPGRADES_TIER_3 = ['fighter', 'booster', 'falcon', 'bomber', 'autoTriAngle', 'surfer', 'eagle', 'phoenix', 'vulture', "rocket"]
