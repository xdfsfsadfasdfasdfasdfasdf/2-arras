...
// T1 available immediately upon entering the Forge and becoming a dreadnought
Class.dreadnought_dreadsV1.UPGRADES_TIER_0 = ["sword", "pacifier", "invader", "centaur"].map(x => x + "_dreadsV1")
...
for (let branch1 of Class.dreadnought_dreadsV1.UPGRADES_TIER_0) {
